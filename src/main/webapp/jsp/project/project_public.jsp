...
<body>
    <div class="Box">
        <div class="box">
                    ...
                    <c:forEach items="${projects}" var="project">
	                	<div class="PJli">
	                        <div class="PJliC">
	                            ...
	                            <a href="/wankangyuan/project/getProjectDetail?id=${project.id}&url=3">
            ...
            <div class="bottom">
                <a href="javascript:;">
                    <div class="bot_guanwang">公司官网${projectQueryCondition.values}</div>
                </a>
                <a href="javascript:;">
    ...
    <script type="text/javascript">
    	...
    	function shaixuan(page){
            ...
            window.location.href="/wankangyuan/projectFilter/selectPublicProjectByFilterCondition1?page="+page+
