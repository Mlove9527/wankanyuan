            ...
            <div class="top2">
                <div class="top2C">
                    <div class="top2Ctl active">
                        <a href="/wankangyuan/sourceData/firstIn?type=${type123}&cs_id=${source.cs_id}">
                ...
                <div class="prodainmR">
             		<c:forEach items="${source.sourceFields}" var="sourceFieldTemp" varStatus="status">
						<div class="prodainmRz1">
	                        ...
	                        <input class="prodainmRz1R" type="text" value="${sourceData[status.index+1] }" />
	                        <%-- <div class="prodainmRz1R">${sourceData[status.index+1] }</div> --%>
                    	</div>
					</c:forEach>
					<div class="prodainmRz1L">ddd</div>
					<div class="prodainmRik">
						<img alt="" class="prodainmRi" src="http://localhost:8080/wankangyuan/static/img/userI.png">
