	...
	<div class="Box">
		<div class="box">
			<div class="top">
				...
				</a> <a href="/wankangyuan/sourceData/getSourceDatas?type=1&ids=&isAll=false">
			...
			<div class="top2">
				<div class="top2C">
					<a href="/wankangyuan/sourceData/getSourceDatas?type=1&ids=&isAll=false&cs_id=${source.cs_id }">
						<div class="top2Cli top2CliYJ">我的</div>
					</a> <a href="/wankangyuan/sourceData/getSourceDatas?type=2&ids=&isAll=false&cs_id=${source.cs_id }">
						<div class="top2Cli">我创建的</div>
					</a> <a href="/wankangyuan/sourceData/getSourceDatas?type=3&ids=&isAll=false&cs_id=${source.cs_id }">
			...
			<div class="shaixuan">
				<div class="shaixuanC">
					<div class="listZT">
						<a href="<%=request.getContextPath()%>/jsp/formatdata/data_mine2.jsp">
			...
			<div class="PJK">
				...
				<!-- <input type="hidden" id="ids2" value="check1_75_277" />
				<input type="hidden" id="isAll2" value="false" /> -->
				<div class="PJulk">
                    <table class="PJul" >
                        <tr class="PJList">
                            <td>
                          ...
                          <!-- 表头 -->
                            <c:forEach items="${source.sourceFields}" var="sourceFieldTemp">
		                           <td>
				                       <div class="PJListli" id="${sourceFieldTemp.csf_id}" title=''>${sourceFieldTemp.csf_name}</div>
				                   </td>
		                    </c:forEach>
                        </tr>
