...
<body>
	<div class="Box">
		<div class="box">
            ...
            <div class="top2">
                <div class="top2C">
                    <a href="/wankangyuan/sourceData/firstIn?type=1&cs_id=${source.cs_id }"><div class="top2Cli">我的</div></a>
                    <a href="/wankangyuan/sourceData/firstIn?type=2&cs_id=${source.cs_id }"><div class="top2Cli top2CliYJ">我创建的</div></a>
            ...
            <div class="shaixuan">
                <div class="shaixuanC">
                    <div class="listZT">
                        ...
                        <a href="<%=request.getContextPath()%>/jsp/formatdata/data_create.jsp">
    	...
    	$('#box').paging({
            ...
            callback: function(page) { // 回调函数
        		...
        		var is_all = isAll();
                 ...
                 if(page!=${page}){ 
                	window.location.href="/wankangyuan/sourceData/getSourceDatas1?type=2&cs_id="+cs_id+"&searchId="+searchId+
