	...
	<div class="Box">
		<div class="box">
			<div class="top">
				...
				</a> <a href="/wankangyuan/sourceData/getSourceDatas?type=3&ids=&isAll=false">
			...
			<div class="top2">
				<div class="top2C">
					<a href="/wankangyuan/sourceData/firstIn?type=1&cs_id=${thiscs_id }">
						<div class="top2Cli">我的</div>
					</a> <a href="/wankangyuan/sourceData/firstIn?type=2&cs_id=${thiscs_id }">
						<div class="top2Cli">我创建的</div>
					</a> <a href="/wankangyuan/sourceData/firstIn?type=3&cs_id=${thiscs_id }">
			...
			<div class="shaixuan">
				<div class="shaixuanC">
					<div class="listZT">
						<a href="<%=request.getContextPath()%>/jsp/formatdata/data_public2.jsp">
